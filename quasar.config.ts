...
export default defineConfig((/* ctx */) => {
  return {
    ...
    boot: ['application-container', 'application-storage', 'validate-access-token'],
    ...
    build: {
      ...
      alias: {
        ...
        condominium: fileURLToPath(new URL('./src/modules/condominium', import.meta.url)),
        router: fileURLToPath(new URL('./src/router', import.meta.url)),
      },
    },
