<!-- !COMPONENTE OBSOLETO, DEBE SER ELIMINADO! -->
<template>
                ...
                <div class="row items-center q-mt-md">
                  ...
                  <div class="col-7">
                    <q-input
                      filled
                      dense
                      v-model="form.tipoDeIdentificacion"
                ...
                <div class="row items-center q-mt-md">
                  ...
                  <div class="col-7">
                    <q-input
                      filled
                      dense
                      v-model="form.numeroDeIdentificacion"
...
const readUserUseCase = applicationContainer.getFromContainer(GetUserUseCase);
...
const confirmAndDeleteUser = async (user: UserDto | null) => {
  ...
  if (confirmed) {
    try {
      await deleteUserUseCase.handle(new DeleteUserDto(user.id));
